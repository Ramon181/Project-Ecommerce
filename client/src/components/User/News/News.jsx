  ...
  return (
    <div className="max-w-screen-xl p-5 mx-auto dark:bg-gray-800 dark:text-gray-100">
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-4 sm:grid-cols-2">
        {datas &&
          datas.map(e => (
            <div class="bg-white shadow-md rounded-lg dark:bg-gray-800 dark:border-gray-700">
              <Link to={`/products/${e.id}`} href="#">
                <img
                  class="rounded-t-lg w-full h-3/5 p-8"
                  src={e.image}
                 alt=""
                />
              </Link>
              <div class="px-5 pb-5">
                ...
                <div class="flex items-center mt-20 w-full h-full justify-between">
      ...
      <Link to={"/products"} class="inline-flex mt-5" href>
          ...
          <span class="h-12 w-12 flex-shrink-0 flex items-center justify-center border border-l-0 border-black hover:bg-black hover:text-white transition duration-500 ease-in-out">
            <svg
              class="h-3 w-3 svg-inline--fa fa-chevron-right fa-w-8 fa-9x"
              aria-hidden="true"
              focusable="false"
