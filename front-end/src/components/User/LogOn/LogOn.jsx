...
const LogOn = ({setRegisterModal}) => {
  ...
  return (
    <div className="bg-gray-100 text-gray-500 rounded shadow-xl w-full overflow-hidden">
      <div className="md:flex w-full">
        <div className="hidden md:block w-1/2 bg-[#131921] py-5 px-5">
          <svg
        ...
        <form onSubmit={onSubmit} className="w-full md:w-1/2 py-10 px-5 md:px-5">
          ...
          <div>
              ...
              <div className="w-full px-3 mb-5">
                ...
                <div className="flex">
                  ...
                  <input
                    ...
                    className="w-full -ml-10 pl-2 pr-1 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                    placeholder="John"
                  />
                </div>
                {name.validate === false && name.text === "" ? (
                  <div className="text-red-800 text-sm p-4 flex justify-between absolute right-[17.8rem] top-[-4rem]">
                    <div>
                ...
                ) : name.validate === false && name.text.length < 3 ? (
                  <div className="text-red-800 text-sm p-4 flex justify-between absolute right-[10.1rem] top-[-4rem]">
                    <div>
                      <div className="flex items-center">
                        <p>
                          <span className="font-bold">Info: </span>
                          It should have more than three letters
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="flex -mx-3">
              <div className="w-full px-3 mb-5">
                ...
                {userName.validate === false && userName.text === "" ? (
                  <div className="text-red-800 text-sm p-4 flex justify-between absolute right-[17.8rem] top-[1.5rem]">
                    <div>
                      <div className="flex items-center">
                        <p>
                          <span className="font-bold"> Info: </span>
                ...
                ) : userName.validate === false && userName.text.length < 3 ? (
                  <div className="text-red-800 text-sm p-4 flex justify-between absolute right-[10.1rem] top-[1.5rem]">
                    <div>
                      <div className="flex items-center">
                        <p>
                          <span className="font-bold">Info: </span>
            ...
            <div className="flex -mx-3">
              <div className="w-full px-3 mb-5">
                ...
                {email.validate === false && email.text === "" ? (
                  <div className="text-red-800 text-sm p-4 flex justify-between absolute right-[17.8rem] top-[7rem]">
                    <div>
                      <div className="flex items-center">
                        <p>
                          <span className="font-bold"> Info: </span>
                ...
                ) : email.validate === false && email.text.length < 3 ? (
                  <div className="text-red-800 text-sm p-4 flex justify-between absolute right-[10.1rem] top-[7rem]">
                    <div>
                      <div className="flex items-center">
                        <p>
                          <span className="font-bold">Info: </span>
            ...
            <div className="flex -mx-3">
              <div className="w-full px-3 mb-12">
                ...
                {password.validate === false && password.text === "" ? (
                  <div className="text-red-800 text-sm p-4 flex justify-between absolute right-[17.8rem] top-[12.5rem]">
                    <div>
                      <div className="flex items-center">
                        <p>
                          <span className="font-bold"> Info: </span>
                ...
                ) : password.validate === false && password.text.length < 3 ? (
                  <div className="text-red-800 text-sm p-4 flex justify-between absolute right-[10.1rem] top-[12.5rem]">
                    <div>
                      <div className="flex items-center">
                        <p>
                          <span className="font-bold">Info: </span>
            ...
            <div className="flex -mx-3">
              <div className="w-full px-3 mb-5">
                <button type="submit" className="block w-full max-w-xs mx-auto bg-[#131921] hover:bg-[#243041] focus:bg-[#142031] text-white rounded-lg px-3 py-3 font-semibold">
                  REGISTER NOW
                </button>
              </div>
            </div>
