    ...
    <div className="sidebar">
      ...
      <ul className="sidebar-list">
        <li className="sidebar-list-item">
          <Link to={"/"} className="link_side" href="#">
            <svg
        ...
        <li className="sidebar-list-item active">
          <Link to={"/products"} className="link_side" href="#">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
              height="18"
        ...
        <li className="sidebar-list-item">
          <Link to={"/users"} className="link_side" href="#">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
              height="18"
        ...
        <li className="sidebar-list-item">
          <Link to={"/orders"} className="link_side" href="#">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
              height="18"
      ...
      <div className="account-info">
        <button className="text-white p-2 rounded-xl bg-black" onClick={logOut}>
          logOut
        </button>
      </div>
    </div>
