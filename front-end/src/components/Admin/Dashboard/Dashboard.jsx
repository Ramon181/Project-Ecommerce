              ...
              <div className="grid grid-cols-12 col-span-12 gap-6 xxl:col-span-9">
                <div className="col-span-12 mt-8">
                  <div className="grid grid-cols-12 gap-6 mt-5">
                    <a
                      className="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-gray-600"
                      href="#"
                    >
                      <div className="p-5">
                        ...
                        <div className="ml-2 w-full flex-1">
                          <div>
                            <div className="mt-3 text-gray-100 text-3xl font-bold leading-8">
                              4.510
                            </div>
                    ...
                    >
                      <div className="p-5">
                        ...
                        <div className="ml-2 w-full flex-1">
                          <div>
                            <div className="mt-3 text-3xl text-gray-100 font-bold leading-8">
                              4.510
                            </div>
                ...
                <div className="col-span-12 mt-5">
                  <div className="grid gap-2 grid-cols-1 lg:grid-cols-2">
                    <div className="bg-gray-600 shadow-lg p-4" id="chartline"></div>
                    <div className="bg-gray-600 shadow-lg" id="chartpie"></div>
                  </div>
                </div>
              </div>
            </div>
