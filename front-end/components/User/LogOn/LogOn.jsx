...
const LogOn = ({setRegisterModal}) => {
  ...
  return (
    <div class="bg-gray-100 text-gray-500 rounded shadow-xl w-full overflow-hidden">
      <div class="md:flex w-full">
        <div class="hidden md:block w-1/2 bg-indigo-500 py-5 px-5">
          <svg
        ...
        <form onSubmit={onSubmit} class="w-full md:w-1/2 py-10 px-5 md:px-5">
              ...
              <div class="w-full px-3 mb-5">
                ...
                <div class="flex">
                  ...
                  <input
                    ...
                    class="w-full -ml-10 pl-2 pr-1 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                    placeholder="John"
                  />
                </div>
                {name.validate === false && name.text === "" ? (
                  <div class="text-red-800 text-sm p-4 flex justify-between absolute right-[17.8rem] top-[-4rem]">
                    <div>
                  ...
                  <div class="text-red-800 text-sm p-4 flex justify-between absolute right-[10.1rem] top-[-4rem]">
                    <div>
                      <div class="flex items-center">
                        <p>
                          <span class="font-bold">Info: </span>
            ...
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-5">
                ...
                {userName.validate === false && userName.text === "" ? (
                  <div class="text-red-800 text-sm p-4 flex justify-between absolute right-[17.8rem] top-[1.5rem]">
                    <div>
                      <div class="flex items-center">
                        <p>
                          <span class="font-bold"> Info: </span>
                  ...
                  <div class="text-red-800 text-sm p-4 flex justify-between absolute right-[10.1rem] top-[1.5rem]">
                    <div>
                      <div class="flex items-center">
                        <p>
                          <span class="font-bold">Info: </span>
            ...
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-5">
                ...
                {email.validate === false && email.text === "" ? (
                  <div class="text-red-800 text-sm p-4 flex justify-between absolute right-[17.8rem] top-[7rem]">
                    <div>
                      <div class="flex items-center">
                        <p>
                          <span class="font-bold"> Info: </span>
                  ...
                  <div class="text-red-800 text-sm p-4 flex justify-between absolute right-[10.1rem] top-[7rem]">
                    <div>
                      <div class="flex items-center">
                        <p>
                          <span class="font-bold">Info: </span>
            ...
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-12">
                ...
                {password.validate === false && password.text === "" ? (
                  <div class="text-red-800 text-sm p-4 flex justify-between absolute right-[17.8rem] top-[12.5rem]">
                    <div>
                      <div class="flex items-center">
                        <p>
                          <span class="font-bold"> Info: </span>
                  ...
                  <div class="text-red-800 text-sm p-4 flex justify-between absolute right-[10.1rem] top-[12.5rem]">
                    <div>
                      <div class="flex items-center">
                        <p>
                          <span class="font-bold">Info: </span>
